...
## Project Structure
    ...
    ├── testjdbwdnwefde_dev_49409  # Django project configurations
...
1. Clone this repo and `cd testjdbwdnwefde_dev_49409`
...
2. Clone this repo and `cd testjdbwdnwefde_dev_49409`
